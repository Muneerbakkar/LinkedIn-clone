...
export default function Home() {
  ...
  return (
    <div className="lg:mx-[10%] lg:flex  gap-4 justify-center mt-28 mx-2">
      <div className="col-span-1  text-center lg:w-[20%]">
        <div className="mb-2 rounded-lg lg:rounded-lg  bg-white text-xs text-gray-500 bg-opacity-10 backdrop-blur-sm shadow-2xl">
          <div className="h-15 w-full relative">
            <Image
              ...
              width={300}
              height={10}
              className="object-cover w-full h-full mr-2 mb-5 rounded-t-lg lg:rounded-t-lg"
            />
        ...
        <div className="lg:rounded-lg p-3 bg-white text-xs bg-opacity-10 backdrop-blur-sm shadow-2xl rounded-lg mb-2">
      ...
      <div className="lg:w-[50%]">
        <div className="p-4 lg:rounded-lg rounded-lg bg-white bg-opacity-20 backdrop-blur-sm shadow-lg">
          <div className="flex">
        ...
        <hr className="border-1 border-white mb-4 mt-4" />
        <div className=" bg-white lg:rounded-lg rounded-lg mb-4 bg-opacity-20 backdrop-blur-sm shadow-2xl text-black">
      ...
      <div className="w-[26%] hidden lg:block">
        <div className="bg-white rounded-lg p-4 mb-2 bg-opacity-20 backdrop-blur-sm shadow-2xl">
          <div>
        ...
        <div className="bg-white rounded-lg p-2 text-gray-500 bg-opacity-10 backdrop-blur-sm shadow-2xl">
